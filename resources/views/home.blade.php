                    ...
                    <form action="{{ route('contact.send') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                    class="w-full px-4.5 py-3.5 rounded-xl bg-slate-950/80 text-white focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors placeholder-slate-600 text-sm @error('name') border-red-500 focus:border-red-500 focus:ring-red-500/20 @else border-slate-800 focus:border-blue-500 @enderror" placeholder="John Doe">
                                @error('name')
                                    <p class="text-xs text-red-400 mt-1.5 flex items-center font-semibold">
                                        <svg class="w-4 h-4 mr-1 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                        {{ $message }}
                                    </p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" required
                                    class="w-full px-4.5 py-3.5 rounded-xl bg-slate-950/80 text-white focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors placeholder-slate-600 text-sm @error('email') border-red-500 focus:border-red-500 focus:ring-red-500/20 @else border-slate-800 focus:border-blue-500 @enderror" placeholder="john@example.com">
                                @error('email')
                                    <p class="text-xs text-red-400 mt-1.5 flex items-center font-semibold">
                                        <svg class="w-4 h-4 mr-1 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                        {{ $message }}
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5" required
                                class="w-full px-4.5 py-3.5 rounded-xl bg-slate-950/80 text-white focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors placeholder-slate-600 resize-none text-sm @error('message') border-red-500 focus:border-red-500 focus:ring-red-500/20 @else border-slate-800 focus:border-blue-500 @enderror" placeholder="How can I help you?">{{ old('message') }}</textarea>
                            @error('message')
                                <p class="text-xs text-red-400 mt-1.5 flex items-center font-semibold">
                                    <svg class="w-4 h-4 mr-1 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                    {{ $message }}
